            ...
            <div class="shop_top">
                <div class="container">
                    <form action="Controller" method="post">
                        ID:<br><input type="text" name="txtID" value="<%= request.getAttribute("id")%>"><br>
                        Name:<br><input type="text" name="txtName" value="<%= request.getAttribute("name")%>"><br>
                        Model:<br><input type="text" name="txtModel" value="<%= request.getAttribute("Model")%>" /><br>
                        Category:<br><input type="text" name="txtCategory" value="<%= request.getAttribute("category")%>" ><br><br>
                        <input class="btn btn-success" type="submit" value="Create new Product" name="btnAction" />
                    </form>
                </div>
            </div>
        </div>
