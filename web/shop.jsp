            ...
            <div class="shop_top">
                <div class="container">
                    ...
                    <div class="row shop_box-top">
                       <% 
                                for (SanPham sp : spDAO.getListSanPham()) {
                              %>
                              <div class="col-md-3 shop_box"><a href="single.jsp?TenSP=<%=sp.getTenSP()%>">
                             
                                <img src="<%=sp.getHinhAnh()%>" class="img-responsive" alt=""/>
                                <span class="new-box">
                                ...
                                <div class="shop_desc">
                                    <h3><a href="#"><font color="red"><%=sp.getTenSP()%></font></a></h3>
                                    <p><%=sp.getChuThich()%></p>
                                    <font color="blue"><span>$ <%=sp.getGia()%> </span></font>                                    
                                    <ul class="buttons">
                                        <li class="cart"><a href="#">Add To Cart</a></li>
                                        <li class="shop_btn"><a href="single.jsp?TenSP=<%=sp.getTenSP()%>">Read More</a></li>
                                        <div class="clear"> </div>
                                    </ul>
                                </div>
                             </a>
