            ...
            <div class="shop_top">
                <div class="container">
                    <form> 
                        <div class="col-md-6">
                            <div class="col-md-6">
                                <Button type="Register"><a href="register.jsp">Register New Account</a></button>

                                <%
                                    SanPham sp = new SanPham();
                                    ArrayList<SanPham> ds = sp.showProduct();
                                    for (int i = 0; i < ds.size(); i++) {

                                %>
                                <tr style="line-height: 2">
                                    <td><%= ds.get(i).getTenSP()%></td>     
                                    <td><%= ds.get(i).getChuThich()%></td>
                                    <td><%= ds.get(i).getHinhAnh()%></td>
                                    <td><%= ds.get(i).getGia()%></td>
                                    <td><%= ds.get(i).getDec()%></td>
                                    <td><a href="ControllerTest?btnAction=Delete&value=<%= ds.get(i).getTenSP()%>" style="color: red">Delete</a></td>
                                    <td><a href="ControllerTest?btnAction=Update&value=<%= ds.get(i).getTenSP()%>" style="color: red">Update</a></td>
                                    <td><a href="Insert.jsp" style="color: red">Insert</a></td>
                                </tr>
                                <%
                                    }
                                %>
