                ...
                <div class="container">
                                ...
                                <ul id="etalage">
                                    <li>
                                        <a href="optionallink.jsp">
                                            <img class="etalage_thumb_image" src="<%=sp.getHinhAnh()%>" />
                                            <img class="etalage_source_image" src="<%=sp.getHinhAnh()%>" />
                                        </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 product1">
                            ...
                            <div class="shop_desc"><a href="single.jsp">
                                </a><h3><a href="single.jsp"></a><a href="#">aliquam volutp</a></h3>
